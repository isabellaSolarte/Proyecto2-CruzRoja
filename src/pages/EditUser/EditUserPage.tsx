import { CustomColumn, CustomInput, DataTable, ManagmentLayout } from '../../components';
import { useEffect } from 'react';
import { useTranslation } from 'react-i18next';
import { Form, useParams } from 'react-router-dom';
import AccountCircleIcon from '@mui/icons-material/AccountCircle';
import HighlightOffIcon from '@mui/icons-material/HighlightOff';
import { CustomButton, CustomText, CustomAccordion } from '../../components';
...
const EditUserPage = () => {
  ...
  const {userData,roles,loadCompanyUserDataToEdit, loadVolunteerUserDataToEdit,handleSave, handleCancel, onSubmit, handleSubmit,register} = useEditUser();
  const userPosition = (userData as VolunterUserModel)?.position || t('positions.business_representative');
  useEffect(() => {
    void loadCompanyUserDataToEdit(Number(id));
    void loadVolunteerUserDataToEdit(Number(id));
  }, []);
        ...
        generalContents={
          <Box>
            ...
            <Grid item xs={12} md={6} sm={12} paddingInline={3} paddingBlock={2}>
              ...
              />
              <CustomInput placeholder="Nombre" defaultValue={userData ? userData.names : ''} props={register('names')} size="medium" />
            ...
            <Grid item xs={12} md={6} sm={12} paddingInline={3} paddingBlock={2}>
              <CustomText
                ...
                icon={<AccountBoxIcon color="disabled" />}
              />
              <CustomInput placeholder="Apellidos" defaultValue={userData ? userData.lastNames : ''} props={register('lastNames')} size="medium" />
            ...
            <Grid item xs={12} md={6} sm={12} paddingInline={3} paddingBlock={2}>
              ...
              />
              <CustomInput placeholder="Telefono" defaultValue={userData ? userData.personalPhone : ''} props={register('personalPhone')} size="medium" />
            ...
            <Grid item xs={12} md={6} sm={12} paddingInline={3} paddingBlock={2}>
              ...
              />
              <CustomInput placeholder="Email" defaultValue={userData ? userData.personalEmail : ''} props={register('personalEmail')} size="medium" />
