...
const CompensationPlanPage = () => {
  ...
  const buttons = [viewButton, ...(hasPermission(1004) ? [editButton] : []), acquireButton];
        ...
        <Box sx={{ display: 'flex', alignItems: 'start' }}>
          ...
          {hasPermission(1001) ? (
            <CustomButton
              ...
              style={{ marginLeft: '10px', color: '#65B741', fontWeight: 'bold' }}
            />
          ) : null}
        </Box>
      }
              ...
              <>
                {hasPermission(1002) ? (
                  ...
                  <Alert severity="error">
                    No cuentas con los permisos para visualizar planes personales
                  </Alert>
                )}
              </>,
            ]}
                    ...
                    <Autocomplete
                      ...
                      renderInput={params => (
                        <TextField
                          ...
                          helperText={
                            error && !formData.companyNit ? 'Este campo es obligatorio.' : ''
                          }
                        />
                      )}
                    />
                  </Grid>
                  <Grid item xs={10} paddingTop={3} sx={{ paddingLeft: 5 }}></Grid>
