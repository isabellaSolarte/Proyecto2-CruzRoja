...
const CalculatorPage = () => {
  ...
  const handleClick = () => {
    ...
    // Verificar si currentStep está dentro del rango esperado
    if (currentStep >= 1 && currentStep <= Object.keys(stepsFunctions).length) {
      ...
      // Manejar el caso en el que currentStep esté fuera del rango esperado
      console.error(`currentStep está fuera del rango esperado: ${currentStep}`);
    }
  };
